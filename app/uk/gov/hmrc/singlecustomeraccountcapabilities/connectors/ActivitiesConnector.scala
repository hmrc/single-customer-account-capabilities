...
class ActivitiesConnector @Inject()(appConfig: AppConfig, httpClientV2: HttpClientV2) {

  private val endpoint = s"${appConfig.capabilitiesDataBaseUrl}/individuals/activities/NINO/%s"
